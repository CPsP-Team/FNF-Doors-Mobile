...
class DoorsOption extends FlxSpriteGroup {
    ...
    private function handleStandardOptionUpdate(elapsed:Float) {
        ...
        } else if (#if desktop Controls.instance.UI_LEFT_R || Controls.instance.UI_RIGHT_R || FlxG.mouse.justReleased #else || virtualPad.buttonLeft.justPressed || virtualPad.buttonRight.justPressed #end) {
            clearHold();
        }
    }
