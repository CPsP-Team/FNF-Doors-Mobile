...
class AsyncUpdater {
	...
	public static var executableName:String = "FNF Doors.exe";
	...
	public function installFiles(files:Array<String>) {
		progress.step = REMOVING_OLD;
		deleteDirRecursively("assets/");
		deleteDirRecursively("mods/");
	...
	public function prepareInstallationEnvironment() {
		...
		path = '${Sys.getEnv("TEMP")}\\Doors Engine\\Updater\\';
