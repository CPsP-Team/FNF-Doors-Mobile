...
class Controls
{
	...
	public var HEARTBEAT_LEFT_P(get, never):Bool;
	public var HEARTBEAT_RIGHT_P(get, never):Bool;
	...
	private function get_HEARTBEAT_LEFT_P()
		return justPressed('heartbeat_left');

	private function get_HEARTBEAT_RIGHT_P()
		return justPressed('heartbeat_right');
	...
	public var HEARTBEAT_LEFT(get, never):Bool;
	public var HEARTBEAT_RIGHT(get, never):Bool;
	...
	private function get_HEARTBEAT_LEFT()
		return pressed("heartbeat_left");

	private function get_HEARTBEAT_RIGHT()
		return pressed("heartbeat_right");
	...
	public var HEARTBEAT_LEFT_R(get, never):Bool;
	public var HEARTBEAT_RIGHT_R(get, never):Bool;
	...
	private function get_HEARTBEAT_LEFT_R()
		return justReleased('heartbeat_left');

	private function get_HEARTBEAT_RIGHT_R()
		return justReleased('heartbeat_right');
	...
	public var ITEM1(get, never):Bool;
	public var ITEM2(get, never):Bool;
	public var ITEM3(get, never):Bool;
	public var ITEM4(get, never):Bool;
	public var ITEM5(get, never):Bool;
	public var ITEM6(get, never):Bool;
	...
	private function get_ITEM1()
		return justPressed('item1');

	private function get_ITEM2()
		return justPressed('item2');

	private function get_ITEM3()
		return justPressed('item3');

	private function get_ITEM4()
		return justPressed('item4');

	private function get_ITEM5()
		return justPressed('item5');

	private function get_ITEM6()
		return justPressed('item6');
