...
class Controls
{
	...
	private function get_HEARTBEAT_LEFT() return pressed("heartbeat_left");
	private function get_HEARTBEAT_RIGHT() return pressed("heartbeat_right");
	...
	private function get_HEARTBEAT_LEFT_R() return justReleased('heartbeat_left');
	private function get_HEARTBEAT_RIGHT_R() return justReleased('heartbeat_right');
	...
	private function get_ITEM1() return justPressed('item1');
	private function get_ITEM2() return justPressed('item2');
	private function get_ITEM3() return justPressed('item3');
	private function get_ITEM4() return justPressed('item4');
	private function get_ITEM5() return justPressed('item5');
	private function get_ITEM6() return justPressed('item6');

	//Gamepad & mobile & Keyboard stuff
